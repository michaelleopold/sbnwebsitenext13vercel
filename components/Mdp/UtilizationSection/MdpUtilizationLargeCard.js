...
const MdpUtilizationLargeCard = ({
  ...
  <div className="relative">
    ...
    <h1 className={`absolute ${top} ${topXl} ${top2Xl} left-7 text-white font-semibold text-[1.75rem] xl:text-[1.8rem] 2xl:text-[2rem] leading-9 ${maxWdith} 2xl:max-w-[36rem] z-10`}>{description}</h1>
  </div>
);
